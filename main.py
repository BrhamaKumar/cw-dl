...
bc_url = (f"https://edge.api.brightcove.com/playback/v3/accounts/{ACCOUNT_ID}/videos")
...
async def account_login(bot: Client, m: Message):
    ...
    if "*" in raw_text:
      ...
      token = raw_text
    html1 = s.get("https://elearn.crwilladmin.com/api/v3/comp/my-batch?&token="+str(token)).json()
